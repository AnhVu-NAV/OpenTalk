...
import styles from "./styles/module/SalaryPage.module.css"
...
const SalaryPage = () => {
    ...
    return (
        <div className={styles.salaryPageContainer}>
            ...
            <div className={styles.salaryControls}>
                ...
                <div style={{ display: "flex", gap: "10px" }}>
                    ...
                    <button className={styles.btnCalculate} onClick={handleCalculate} disabled={loading}>
                        {loading ? "Calculating..." : "➕ Calculate Bonus"}
                    </button>
                </div>
            </div>

            <div className={styles.salaryTableWrapper}>
                            ...
                            <tr key={salary.id}>
                                <td>
                                    <div className={styles.employeeInfo}>
                                        <img src="/placeholder.svg" alt={salary.recipientName} className={styles.employeeAvatar} />
                                ...
                                <td>${salary.bonus}</td>
                                <td>
                    <span className={`${styles.statusBadge} ${styles[salary.status?.toLowerCase()]}`}>
                      {salary.status}
                    </span>
                                </td>
                                <td>
                ...
                {totalRecords > 0 && (
                    <div className={styles.paginationControls}>
                        ...
                        <div>
                            Showing {(currentPage - 1) * itemsPerPage + 1} to {Math.min(currentPage * itemsPerPage, totalRecords)} of{" "}
            ...
            {showModal && (
                <SalaryDetailModal
                    ...
                    onStatusChange={(e) => setSelectedSalary({ ...selectedSalary, status: e.target.value })}
